...
try:
    final_thicknesses = np.loadtxt('optimized_thicknesses_needle_v2.txt')
...
try:
    final_T = np.loadtxt('final_spectrum_needle_v2.csv', delimiter=',')
...
plt.title("Needle Optimized Layer Bandpass Filter", fontsize=14, fontweight='bold')
...
plt.savefig('NO2_Result_Plot.png', bbox_inches='tight')
plt.tight_layout()
plt.show()
