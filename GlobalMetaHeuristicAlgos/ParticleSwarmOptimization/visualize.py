...
try:
    final_thicknesses = np.loadtxt('optimized_thicknesses_pso.txt')
...
try:
    final_T = np.loadtxt('final_spectrum_pso.csv', delimiter=',')
...
plt.title("PSOptimized 23-Layer Bandpass Filter", fontsize=14, fontweight='bold')
...
plt.savefig('23_Layer_Result_Plot.png', bbox_inches='tight')
plt.tight_layout()
plt.show()
