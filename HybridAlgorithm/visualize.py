...
try:
    final_thicknesses = np.loadtxt('optimized_thicknesses_hybrid_2.txt')
...
try:
    final_T = np.loadtxt('final_spectrum_hybrid_2.csv', delimiter=',')
...
plt.title("Hybrid PSO+L-BFGS Optimized 23-Layer Bandpass Filter", fontsize=14, fontweight='bold')
...
plt.savefig('HybridAAlgo_23_Layer_Result_Plot.png', bbox_inches='tight')
plt.tight_layout()
plt.show()
