...
ax2.legend(custom_lines, ['SiO2 (Low)', 'TiO2 (High)', 'Al2O3 (Medium)'], loc='upper right')
...
# =========================================================
plt.tight_layout()
plt.savefig('Final_3Material_45Topology_Report_4.png', dpi=300, bbox_inches='tight')
plt.show()
