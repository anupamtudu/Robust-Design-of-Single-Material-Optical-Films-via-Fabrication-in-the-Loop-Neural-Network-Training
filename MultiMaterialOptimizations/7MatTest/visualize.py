...
try:
    ...
    transmittance = np.loadtxt('final_spectrum_topo_6.csv', delimiter=',')
    wavelengths = np.linspace(300, 2500, len(transmittance))
    
    # Load the physical design
    thicknesses = np.loadtxt('optimized_thicknesses_topo_6.txt')
    materials = np.loadtxt('optimized_materials_topo_6.txt', dtype=int)
...
# =========================================================
plt.tight_layout()
plt.savefig('Final_7Material_Topology_Report_6.png', dpi=300, bbox_inches='tight')
plt.show()
