...
try:
    final_thicknesses = np.loadtxt('optimized_thicknesses_f2.txt')
...
try:
    final_T = np.loadtxt('final_spectrum_f2.csv', delimiter=',')
...
plt.title("AI-Optimized 23-Layer Bandpass Filter", fontsize=14, fontweight='bold')
