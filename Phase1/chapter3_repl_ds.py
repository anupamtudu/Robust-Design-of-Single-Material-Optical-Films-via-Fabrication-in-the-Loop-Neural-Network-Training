...
def train_ch3():
    ...
    os.makedirs("ch3_out2_ds_NEW", exist_ok=True)
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig("ch3_out2_ds/stage1_convergence.png", dpi=160)
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig("ch3_out2_ds/stage2_convergence.png", dpi=160)
    ...
    plt.xlim(400, 700)
    plt.tight_layout()
    plt.savefig("ch3_out2_ds/spectra_storyline.png", dpi=180)
    ...
    plt.tight_layout()
    plt.savefig("ch3_out2_ds/mc_hist.png", dpi=160)

    # Save JSON summary
    with open("ch3_out2_ds/results.json", "w") as f:
        json.dump(results, f, indent=2)

    print("\n[Done] Outputs saved in ./ch3_out2_ds")
