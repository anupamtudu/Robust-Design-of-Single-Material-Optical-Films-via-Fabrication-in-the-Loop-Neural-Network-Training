...
def train_ch3():
    ...
    os.makedirs("ch3_out2_lp_NEW", exist_ok=True)
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig("ch3_out2_lp_NEW/stage1_convergence.png", dpi=160)
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig("ch3_out2_lp_NEW/stage2_convergence.png", dpi=160)
    ...
    plt.xlim(400, 700)
    plt.tight_layout()
    plt.savefig("ch3_out2_lp_NEW/spectra_storyline.png", dpi=180)
    ...
    plt.tight_layout()
    plt.savefig("ch3_out2_lp_NEW/mc_hist.png", dpi=160)

    # Save JSON summary
    with open("ch3_out2_lp_NEW/results.json", "w") as f:
        json.dump(results, f, indent=2)

    print("\n[Done] Outputs saved in ./ch3_out2_lp_NEW")
